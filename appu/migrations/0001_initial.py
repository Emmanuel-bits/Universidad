# Generated by Django 5.2.1 on 2025-06-26 19:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idcarrera', models.ForeignKey(db_column='idCarrera', on_delete=django.db.models.deletion.DO_NOTHING, to='appu.carrera')),
                ('idestudiante', models.ForeignKey(db_column='idEstudiante', on_delete=django.db.models.deletion.DO_NOTHING, to='appu.estudiante')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idaula', models.ForeignKey(db_column='idAula', on_delete=django.db.models.deletion.DO_NOTHING, to='appu.aula')),
                ('idestudiante', models.ForeignKey(db_column='idEstudiante', on_delete=django.db.models.deletion.DO_NOTHING, to='appu.estudiante')),
                ('idmateria', models.ForeignKey(db_column='idMateria', on_delete=django.db.models.deletion.DO_NOTHING, to='appu.materia')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('idmateria', models.ForeignKey(db_column='idMateria', on_delete=django.db.models.deletion.DO_NOTHING, to='appu.materia')),
                ('idprofesor', models.ForeignKey(db_column='idProfesor', on_delete=django.db.models.deletion.DO_NOTHING, to='appu.profesor')),
            ],
            options={
